...
<body>
   ...
   <br> <br> <br>
       <video class="space_ship_launch" src="../../../resources/css/space_ship_launch.mp4" muted autoplay loop></video>
   <br> <br> <br>
      <h3>준궤도 우주비행에서 우주선은 우주에 진입하여 궤도를 도는 일이 없이 행성(통상 지구)의 표면으로 돌아온다.<br><br> 궤도 우주비행에서는 우주선은 행성 주위로 원을 이루는 궤도에 들어선다. 유인 우주비행을 위한 우주선은 승무원 또는 승객들을 내부에 실어 나를 수 있다. <br><br>로봇의 우주 임무를 위한 우주선은 자율적으로 또는 원격 조종으로 운영된다. 행성에 접근하는 로봇 우주선은 우주 탐사선이라 부른다. <br><br>행성의 궤도에 남는 로봇 우주선은 '인공위성'이 된다. 행성간 여행을 위한 성간 우주선은 실제로 존재한다.
